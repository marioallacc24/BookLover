...
public class Register extends AppCompatActivity {
    ...
    private void registration() {
        ...
        mRegister.setOnClickListener(view -> {
            ...
            mAuth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(task -> {
                ...
                if(task.isSuccessful()){
                    ...
                    dao.add(user).addOnFailureListener(err -> Toast.makeText(getApplicationContext(),""+err.getMessage(),Toast.LENGTH_LONG).show());
        ...
        mLogin.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(),Login.class)));
