...
public class Login extends AppCompatActivity {
    ...
    private void loginDetails() {
        ...
        mSignUp.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(),Register.class)));

        //Pokretanje prozora za reset lozinke
        mForgetPass.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(),ForgotPass.class)));
